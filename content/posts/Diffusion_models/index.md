...
![Browian motion](Brownian_motion.png)
<div style="text-align: center;font-size: 0.82em">

Fig1. **Left**: simulated sample paths $X_T$, showing progressive noise injection. **Right**: empirical distribution of $X_T$, approaching a Gaussian, illustrating how data is diffused into pure noise.
...
![Forward modelling](forward.png)
<div style="text-align: center;font-size: 9px">

Fig 2. Forward process in Diffusion models. Destroying image by adding noise.
...
where $\alpha = 1-\beta$ and $\bar{\alpha_{t}}=\prod\limits_{s=1}^{t}\alpha_s$.
...
*With the forward process defined, isn’t the central challenge of diffusion models to generate realistic images rather than destroy them? How does reversing this irreversible-looking diffusion process help to generate meaningful data?*
